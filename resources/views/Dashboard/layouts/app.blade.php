...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/layouts-dashboard.css')}}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <a href="{{route('dashboard-petugas')}}" class="nav-link">
                            <p class="text-white fw-medium fs-5 my-auto">Dashboard</p>
                        </a>
                        <a href="{{route('databuku-petugas')}}" class="nav-link">
                            <p class="text-white fw-medium fs-5 ms-md-2 my-auto">Data Buku</p>
                        </a>
                    </ul>
